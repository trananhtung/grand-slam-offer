...
Hãy dùng skill **`grand-slam-offer`** (trong `~/.codex/skills/grand-slam-offer/`) và chạy ở **CHẾ ĐỘ TỰ ĐỘNG (auto)**:

1. Đọc `SKILL.md` của skill để nắm luồng. Nếu `$ARGUMENTS` đã có mô tả sản phẩm/dịch vụ, dùng luôn làm đầu vào. Nếu trống, hỏi **đúng 1 câu duy nhất** để gom thông tin: sản phẩm/dịch vụ, khách hàng mục tiêu, mức giá hiện tại, mục tiêu.
